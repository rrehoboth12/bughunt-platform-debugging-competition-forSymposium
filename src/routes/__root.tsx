  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "BUG HUNT — Find the Bug. Fix the Code. Beat the Clock. MIRAI, Artificial Intelligence and Data Science, Arunachala College of Engineering for Women.",
      },
